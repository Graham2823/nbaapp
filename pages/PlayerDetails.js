...
const PlayerDetails = () => {
	...
	const comparePlayers = () => {
		axios
			.get(
				`https://nbaapp.vercel.app/api/comparePlayers?p1Name=${p1FirstName}_${p1LastName}&p2Name=${p2FirstName}_${p2LastName}`
			)
			.then((response) => {
							...
							<tbody>
								{playerDetails.stats.length === 0 ? (
									...
									<tr>
										...
										<td>
											{playerDetails.stats[0].fgm === 0
												? `0%`
												: shotPercentage(
														playerDetails.stats[0].fgm,
														playerDetails.stats[0].fga
												  )}
										</td>
										<td>
											{playerDetails.stats[0].fg3m === 0
												? `0%`
												: shotPercentage(
														playerDetails.stats[0].fg3m,
														playerDetails.stats[0].fg3a
												  )}
										</td>
										<td>
											{playerDetails.stats[0].ftm === 0
												? `0%`
												: shotPercentage(
														playerDetails.stats[0].ftm,
														playerDetails.stats[0].fta
												  )}
										</td>
