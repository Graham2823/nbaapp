					...
					<div key={index} className='game'>
						...
						{game.home_team_score > 0 || game.visitor_team_score > 0 ? (
							<>
								...
								<p>
									<a
										href={`/boxScore/BoxScore?gameID=${game.id}&homeTeam=${game.home_team.full_name}&homeTeamID=${game.home_team.id}&homeScore=${game.home_team_score}&awayTeam=${game.visitor_team.full_name}&awayTeamID=${game.visitor_team.id}&awayScore=${game.visitor_team_score}`}>
